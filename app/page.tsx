...
export default function HomePage() {
  return (
    <div>
      ...
      <section id="empreinte-rdc" className="section" aria-label="Notre empreinte en RDC">
        <div className="container" style={{ display: 'grid', gap: 12 }}>
          <h2 style={{ margin: 0 }}>Notre empreinte en RDC</h2>
          <p className="muted" style={{ maxWidth: '70ch' }}>
            3 250 sites actifs dans 18 villes. Uptime moyen 98,9 %. Couverture en
            croissance continue, infrastructures sécurisées et entretenues par des équipes locales.
          </p>
        </div>
      </section>
    </div>
